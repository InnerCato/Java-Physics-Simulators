...
public class Ball {
    ...
    public void move() {
        ...
        if (ballX <= 0) {
           ballX = 0;
            xVel *= -1;
        } else if (ballX + diameter >= GravityAndCollision.screenWidth) {
            ballX = GravityAndCollision.screenWidth - diameter;
            xVel *= -1;
        }
        ...
        if (ballY <= 0) {
            ballY = 0;
            yVel *= -1;
        } else if (ballY + diameter >= GravityAndCollision.screenHeight) {
            ballY = GravityAndCollision.screenHeight - diameter;
            yVel *= -1;
        }
    }
    ...
    public void display(Graphics graphics) {
        ...
        graphics.drawRect(0, 0, GravityAndCollision.screenWidth - 1, GravityAndCollision.screenHeight - 1);
    }
